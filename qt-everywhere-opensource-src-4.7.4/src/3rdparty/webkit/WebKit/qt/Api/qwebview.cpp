...
// SSLAB
void QWebView::boolLoad()
{
    page()->mainFrame()->boolLoad();
}

// SSLAB
void QWebView::loadable()
{
    page()->mainFrame()->loadable();
}

// SSLAB
void QWebView::debugging()
{
    page()->mainFrame()->debugging();
}

// SSLAB
void QWebView::pCaching()
{
    page()->mainFrame()->pCaching();
}

// SSLAB
void QWebView::tracing()
{
    page()->mainFrame()->tracing();
}
