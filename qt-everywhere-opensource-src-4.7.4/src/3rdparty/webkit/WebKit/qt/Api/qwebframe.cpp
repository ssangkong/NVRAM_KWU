...
// SSLAB
#include "../../../WebCore/loader/DocLoader.h"
...
// SSLAB
void QWebFrame::boolLoad()
{
    d->frame->document()->docLoader()->setBoolLoad();    
}

// SSLAB
void QWebFrame::loadable()
{
    d->frame->document()->docLoader()->loadable();
}

// SSLAB
void QWebFrame::debugging()
{
    d->frame->document()->docLoader()->debugging();
}

// SSLAB
void QWebFrame::pCaching()
{
    d->frame->document()->docLoader()->pCaching();
}

// SSLAB
void QWebFrame::tracing()
{
    d->frame->document()->docLoader()->tracing();
}
