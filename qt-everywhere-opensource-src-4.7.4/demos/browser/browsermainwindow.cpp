    ...
    , m_reload(0)
{
    ...
    // SSLAB : Grant permission for using Webkit Inspector.
...
// SSLAB : Custom tools panel.
    toolsMenu->addAction(tr("Disable resource loading"), this, SLOT(slotToggleResourceLoading()));
    toolsMenu->addAction(tr("Enable debug message"), this, SLOT(slotToggleDebugging()));
    toolsMenu->addAction(tr("Enable persistent cache"), this, SLOT(slotTogglePCaching()));
    toolsMenu->addAction(tr("Enable Real tracing tool"), this, SLOT(slotToggleTracing()));
...
// SSLAB
void BrowserMainWindow::slotToggleResourceLoading() {
    m_tabWidget->setLoadable();
}

// SSLAB
void BrowserMainWindow::slotToggleDebugging() {
    m_tabWidget->setDebugging();
}

// SSLAB
void BrowserMainWindow::slotTogglePCaching() {
    m_tabWidget->setPCaching();
}

// SSLAB
void BrowserMainWindow::slotToggleTracing() {
    m_tabWidget->setTracing();
}
...
// SSLAB : Send signal which indicates that an page is just loaded to DocLoader.
    m_tabWidget->boolLoadUrl();
}
