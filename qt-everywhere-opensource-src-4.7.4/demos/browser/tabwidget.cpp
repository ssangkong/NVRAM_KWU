...
// SSLAB
void TabWidget::setDebugging()
{
    WebView *webView = currentWebView();
    if(webView) {
        webView->setDebugging();
    }
}

// SSLAB
void TabWidget::setPCaching()
{
    WebView *webView = currentWebView();
    if(webView) {
        webView->setPCaching();
